...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Fri Mar 11 08:35:59 2022
#
...
class LaserLoggerFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        tool = self.frame_main_toolbar.AddTool(wx.ID_ANY, "Duplicate", wx.Bitmap("./icons/edit-copy-symbolic.symbolic.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "Duplicate cell value entry from row below", "")
        self.Bind(wx.EVT_TOOL, self.OnDuplicateCell, id=tool.GetId())
        self.frame_main_toolbar.AddSeparator()
    ...
    def OnDuplicateCell(self, event):  # wxGlade: LaserLoggerFrame.<event_handler>
        print("Event handler 'OnDuplicateCell' not implemented!")
        event.Skip()
